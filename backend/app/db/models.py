...
class Evidence(Base):
    ...
    evidence_role: Mapped[str] = mapped_column(String, default="background")
    support_type: Mapped[str] = mapped_column(String, default="direct")
    relevance_score: Mapped[float] = mapped_column(Float, default=0.8)
    source_credibility: Mapped[float] = mapped_column(Float, default=0.8)
    extraction_method: Mapped[str] = mapped_column(String, default="llm_extraction")
...
class Analysis(Base):
    ...
    item_evidence_bindings_json: Mapped[str] = mapped_column(Text, default="{}")
    field_evidence_ids_json: Mapped[str] = mapped_column(Text, default="{}")
