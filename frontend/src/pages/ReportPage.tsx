...
import { getEvidence, getReport, getReportCitationBundle, getReportCitations, getSources } from '../lib/api';
...
export default function ReportPage() {
  ...
  if (reportQuery.isError || !reportQuery.data) return (
    <div style={{ padding: 24 }}>
      ...
      <button type="button" className="workspace-retry" onClick={() => reportQuery.refetch()} style={{ marginTop: 12 }}>
        重试
      </button>
    </div>
  );
